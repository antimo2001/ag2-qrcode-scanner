...
function showNotification(...args) {
  ...
  //Add new notification to the first in array of notifications
  notifications.unshift(new Notification(title, {
    body: message
  }));
  //Destruct to get the most recent notification
  const [recent, ...dontcare] = notifications;
  recent.onclick = () => {
